...
namespace FutbolJuego.Systems
{
    ...
    public class SeasonSystem
    {
            ...
            string leagueId = null)
        {
            ...
            Debug.Log($"[SeasonSystem] Season advanced to {career?.season ?? 0}. " +
        ...
        public void AwardLeagueTitle(List<PlayerData> squad, CareerData career = null)
        {
            ...
            Debug.Log($"[SeasonSystem] League title awarded to {squad.Count} players.");
        }
        ...
        public void AwardCupTitle(List<PlayerData> squad, CareerData career = null)
        {
            ...
            Debug.Log($"[SeasonSystem] Cup title awarded to {squad.Count} players.");
        }
        ...
        public void AwardContinentalTitle(List<PlayerData> squad, CareerData career = null)
        {
            ...
            Debug.Log($"[SeasonSystem] Continental title awarded to {squad.Count} players.");
        }
        ...
        public static void AwardGoldenBoot(PlayerData player)
        {
            ...
            Debug.Log($"[SeasonSystem] Golden Boot awarded to {player.name}.");
        }
        ...
        public static void AwardGoldenGlove(PlayerData player)
        {
            ...
            Debug.Log($"[SeasonSystem] Golden Glove awarded to {player.name}.");
        }
        ...
        public bool RetirePlayer(PlayerData player, List<PlayerData> squad)
        {
            ...
            {
                Debug.LogWarning($"[SeasonSystem] {player.name} (age {player.age}) is too young to retire.");
                return false;
            }
            if (!squad.Contains(player))
            {
                Debug.LogWarning($"[SeasonSystem] {player.name} is not in the squad.");
                return false;
            }
            ...
            Debug.Log($"[SeasonSystem] {player.name} (age {player.age}) retired. " +
