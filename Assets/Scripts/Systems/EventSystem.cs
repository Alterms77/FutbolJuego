...
namespace FutbolJuego.Systems
{
    ...
    public class LiveEventSystem
    {
        ...
        public bool ClaimDailyReward(int day)
        {
            ...
            claimedDays.Add(key);
            UnityEngine.Debug.Log($"[LiveEvents] Claimed day {day} reward: {reward.amount} {reward.currencyType}");
            return true;
        }
        ...
        public bool CheckChallengeProgress(WeeklyChallenge challenge, MatchData match)
        {
            ...
            {
                UnityEngine.Debug.Log($"[LiveEvents] Challenge '{challenge.description}' completed!");
                return true;
            }
            return false;
        }
