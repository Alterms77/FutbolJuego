    ...
    public class ProgressionSystem
    {
        ...
        public void AwardMatchXP(bool win, bool draw, int goalDifference)
        {
            ...
            if (currentLevel > oldLevel)
                GD.Print($"[Progression] Level up! Now level {currentLevel}.");

            GD.Print($"[Progression] Awarded {xp} XP. Total: {currentXP}.");
        }
        ...
        public void AwardAchievement(string achievementId)
        {
            ...
            GD.Print($"[Progression] Achievement unlocked: {achievementId}");
        }
