...
namespace FutbolJuego.Systems
{
    ...
    public class CurrencySystem
    {
        ...
        public bool ConvertPremiumToInGame(CareerData career, int premiumCoinsToSpend)
        {
            ...
            {
                GD.PushWarning($"[CurrencySystem] Not enough premium coins. " +
            ...
            GD.Print($"[CurrencySystem] Converted {premiumCoinsToSpend} coins → " +
        ...
        public bool RedeemPack(CareerData career, string packId)
        {
            ...
            if (pack == null)
            {
                GD.PushWarning($"[CurrencySystem] Unknown pack id: {packId}");
                return false;
            }

            if (career.premiumCoins < pack.premiumCoinCost)
            {
                GD.PushWarning($"[CurrencySystem] Not enough premium coins for {pack.displayName}.");
                return false;
            }
            ...
            GD.Print($"[CurrencySystem] Redeemed '{pack.displayName}' → " +
                      $"{career.CurrencySymbol}{gain:N0}.");
            return true;
        }
        ...
        public void AddPremiumCoins(CareerData career, int amount)
        {
            ...
            GD.Print($"[CurrencySystem] +{amount} premium coins. Total: {career.premiumCoins}.");
        }
