...
namespace FutbolJuego.Systems
{
    ...
    public class CareerSystem
    {
        ...
        public CareerData StartCareer(LeagueData league, TeamData team)
        {
            ...
            GD.Print($"[CareerSystem] Career started: {team.name} in {league.name} " +
        ...
        public void ResignFromTeam()
        {
            ...
            {
                GD.PushWarning("[CareerSystem] No active career to resign from.");
                return;
            }
            ...
            GD.Print($"[CareerSystem] Manager resigned from {oldTeam}. " +
        ...
        public void JoinTeam(LeagueData league, TeamData team)
        {
            ...
            GD.Print($"[CareerSystem] Manager joined {team.name} in {league.name} " +
